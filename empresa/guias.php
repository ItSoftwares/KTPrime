...
<html>
    ...
    <body>
        ...
        $lista = listar(realpath(dirname(__DIR__).DIRECTORY_SEPARATOR."servidor".DIRECTORY_SEPARATOR."empresa".DIRECTORY_SEPARATOR.$usuario->id.DIRECTORY_SEPARATOR."guias".DIRECTORY_SEPARATOR));
