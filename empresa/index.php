...
<!--                            <li><a href="obrigacoes"><img src="../img/obrigacao.png"></a><span>Obrigações</span></li>-->
                            ...
                            <li><a href="<? echo $usuario->link_nf_venda; ?>" target="_blank"><img src="../img/venda.png"></a><span>Emitir NF Venda</span></li>
                            <li><a href="<? echo $usuario->link_nf_servico; ?>" target="_blank"><img src="../img/servicos.png"></a><span>Emitir NF Serviço</span></li>
                        </ul>
                   </div>
<!--                    <h3>Informações da sua Empresa</h3>-->
                    <div>
                       ...
                       <div id="empresa">
                            ...
                            <div class="input metade">
                                ...
                                <input type="text" name="telefone_2" placeholder="Telefone 2" required>
                            </div>
                            <div class="input metade">
                                <label>Telefone 3</label>
                                <input type="text" name="telefone_3" placeholder="Telefone 3" required>
                            </div>
                            <div class="input metade">
                                <label>Celular Whatsapp</label>
                                <input type="text" name="celular_whatsapp" placeholder="Celular Whatsapp" required>
                            </div>
                            <div class="input metade">
                                <label>Email 2</label>
                                <input type="email" name="email_reserva" placeholder="Email" required>
                            </div>
                           <div class="input metade">
...
-->
                       ...
                       <h4>Cadastro de Senhas<span>3</span></h4>
                       ...
                       <h4>Outras Informações<span>4</span></h4>
