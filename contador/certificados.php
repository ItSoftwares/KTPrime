...
<html>
            ...
            <div>
                ...
                <section id="mensagem">
                    ...
                    <form>
                        ...
                        <p>Para: <span>Empresa</span></p>
                        
                        <textarea name="mensagem" placeholder="Digite sua mesagem aqui"></textarea>
                        <img src="../img/loading.gif" class="carregar">
    ...
    <script type="text/javascript" src='../js/contador/certificado.js?<? echo time() ?>'></script>
</html>