...
<html> 
    ...
    <body>
        ...
        $historico = DBselect("historico_servicos h INNER JOIN empresa e ON h.id_empresa = e.id","order by ano, mes DESC, e.razao_social ASC","h.*, e.razao_social, e.dia_vencimento");
