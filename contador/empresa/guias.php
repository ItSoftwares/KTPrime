...
<html>
    <head>
        <title>KT Prime - Guias de Imposto</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        $lista = listar(realpath(dirname(__DIR__).DIRECTORY_SEPARATOR."..".DIRECTORY_SEPARATOR."servidor".DIRECTORY_SEPARATOR."empresa".DIRECTORY_SEPARATOR.$empresa->id.DIRECTORY_SEPARATOR."guias".DIRECTORY_SEPARATOR));
        $lista = utf8ize($lista);
//        var_dump($lista);
        ?>
