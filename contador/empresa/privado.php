...
<html>
    <head>
        <title>KT Prime - Arquivos Ocultos</title> 
        <meta charset="utf-8">
    ...
    <body>
        ...
        $lista = listar(realpath(dirname(__DIR__).DIRECTORY_SEPARATOR."..".DIRECTORY_SEPARATOR."servidor".DIRECTORY_SEPARATOR."empresa".DIRECTORY_SEPARATOR.$empresa->id.DIRECTORY_SEPARATOR."privado".DIRECTORY_SEPARATOR));
        $lista = utf8ize($lista);
//        var_dump($lista);
        ?>
        ...
        <div id="container">
            <div>
                ...
                <section id="arquivos">
                    <h3>Arquivos que estão ocultos à empresa</h3>
<!--                    <p>Abaixo estão listados as guias de imposto dessa empresa</p>-->
                        ...
                        <div id="enviar-arquivos">
                            <form>
                                <label for="input-upload">
                                    ...
                                    <p>Clique ou Arraste o arquivo a ser enviado!</p>
                                    <span id="nome"></span>
                                </label>
