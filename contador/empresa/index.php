        ...
        <div id="container">
            <div>
                ...
                <section id="informacoes">
                    ...
                    <div id="ativar" <? echo $empresa->estado_conta==1?"class='bloquear' title='Desativar Empresa'":"class='desbloquear' title='Ativar Empresa'"; ?>>
                        <img src="../img/<? echo $empresa->estado_conta==1?"cadeado":"cadeado-destrancado"; ?>.png">
                    </div>
                   ...
                   <form>
                       ...
                       <div id="cliente">
                           <div class="input metade">
                            ...
                            <div class="input metade">
                                ...
                                <input type="text" name="percentual_socio_1" placeholder="% Participação no capital" step="0.01">
                            </div>
                            <div class="input metade">
                       ...
                       <div id="empresa">
                            ...
                            <div class="input metade">
                                ...
                                <input type="text" name="codigo_cliente" placeholder="Código Cliente" data-mask="00/00/0000">
                            </div>
                            <div class="input metade">
                            ...
                            <div class="input <? echo $_SESSION['usuario_logado']!=1?"":"metade"; ?>">
                                <label>Rua</label>
